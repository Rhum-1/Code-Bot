...
export default async function giveIngredient(res) {
  ...
  cardsReplies.push({
    name: 'Performance +',
    picture: 'https://raw.githubusercontent.com/Rhum-1/Code-Bot/master/assets/profil-perf-1.png',
    payload: 'Je veux choisir la performance 1',
  })
  cardsReplies.push({
    name: 'Performance ++',
    picture: 'https://raw.githubusercontent.com/Rhum-1/Code-Bot/master/assets/profil-perf-2.png',
    payload: 'Je veux choisir la performance 2',
  })
  cardsReplies.push({
    name: 'Performance +++',
    picture: 'https://raw.githubusercontent.com/Rhum-1/Code-Bot/master/assets/profil-perf-3.png',
